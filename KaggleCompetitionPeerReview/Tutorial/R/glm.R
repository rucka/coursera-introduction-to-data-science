setwd("~/Google Drive/Projects/coursera-introduction-to-data-science/KaggleCompetitionPeerReview/Tutorial/R")
...
write.csv(kaggle.sub, file="glm.csv", row.names = FALSE)